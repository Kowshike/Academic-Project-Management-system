...
<ul>
    ...
    <li><a href="viewstudents">Studentslist</a></li>
...
<td>
<form:select path="branch" required="required">
<form:option value="-1">---Select---</form:option>
<form:option value="CSE">Cse</form:option>
<form:option value="CSIT">Csit</form:option>
<form:option value="MECH">Mechanical</form:option>
...
<tr>
<td><label>project-allocated</label></td>
<td>
<form:select path="branch" required="required">
<form:option value="-1">---Select---</form:option>
<form:option value="Food & Hospitality Management">Food & Hospitality Management</form:option>
<form:option value="Health & Life Insurance">Health & Life Insurance</form:option>
<form:option value="Academic project management system">Academic project management system</form:option>
<form:option value="Hotel Management system">Hotel Management system</form:option>
<form:option value="Arts gallery System">Arts gallery System</form:option>
<form:option value="Car Rental system">Car Rental system</form:option>
</form:select>
</td>
</tr>
