...
<br><br>
    <main>
        <div class="container">
            <div class="header">
                <h2>Review the Team</h2>
                <span class="blink">
</span>
	<form action="/updatestatusbyid" method="post">
		<table>
		<tr>
				<td>Enter the Project Progress(%):</td>
				<td> <input type="number" name="progress" required="required"> </td>
			</tr>
			<tr>
				<td>Enter the Project Remarks:</td>
				<td> <input type="text" name="remarks" required="required"> </td>
			</tr>
